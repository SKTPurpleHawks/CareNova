...
class _ForeignHomeScreenState extends State<ForeignHomeScreen> {
  ...
  Future<void> fetchUserInfo() async {
    final url = Uri.parse('http://192.168.232.218:8000/user-info');
  ...
  Future<void> _respondToCareRequest(bool accept, dynamic requestId) async {
    final url = Uri.parse('http://192.168.232.218:8000/care-request/$requestId');
  ...
  Future<void> _updateJobInfo(bool value) async {
    final url = Uri.parse('http://192.168.232.218:8000/update-job-info');
